...
class ATL_NO_VTABLE Ctest :
	...
	public IDispatchImpl<Itest, &IID_Itest, &LIBID_MFCActiveXControltestLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
#endif
	public IProvideClassInfo2Impl<&CLSID_test, &__uuidof(_ItestEvents), &LIBID_MFCActiveXControltestLib>,
...
public:
	...
	STDMETHOD(OpenCom)(int nIdx);
	STDMETHOD(OpenCom2)(int nIdx, UINT uiSpeed, ULONG* retval);
};
