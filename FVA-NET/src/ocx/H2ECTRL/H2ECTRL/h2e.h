...
#define H2E_ERR_WSASTARTUP				-300		//WSAStartup failed, Ws2_32.dll load error.
#define H2E_ERR_GETADDRINFO				-301		//Getaddrinfo failed.
#define H2E_ERR_SOCKET					-302		//Socket failed.
#define H2E_ERR_BIND					-303		//Bind failed.
#define H2E_ERR_LISTEN					-304		//Listen failed.
#define H2E_ERR_ACCEPT					-305		//Accept failed.
#define H2E_ERR_SOCKET_SEND				-306		//
...
//Tuch Sensor Status
#define H2E_TOUCH_OUT1						0x01		//TUCH_OUT1 line active  
#define H2E_TOUCH_OUT2						0x02		//TUCH_OUT2 line active
