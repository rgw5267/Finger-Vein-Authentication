// H2ECTRL.cpp : CH2ECTRLApp 和 DLL 注册的实现。
...
class CH2ECTRLModule :
	public ATL::CAtlMfcModule
{
public:
	DECLARE_LIBID(LIBID_H2ECTRLLib);
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_H2ECTRL, "{59734DDC-7DD3-4A99-93F9-C8E903F23388}");};

CH2ECTRLModule _AtlModule;

CH2ECTRLApp theApp;

const GUID CDECL _tlid = { 0x87771D10, 0x1729, 0x4B91, { 0xA7, 0x44, 0xE7, 0x7C, 0xFD, 0x22, 0x84, 0x9 } };
const WORD _wVerMajor = 1;
const WORD _wVerMinor = 0;



// CH2ECTRLApp::InitInstance - DLL 初始化

BOOL CH2ECTRLApp::InitInstance()
{
...
// CH2ECTRLApp::ExitInstance - DLL 终止

int CH2ECTRLApp::ExitInstance()
{
	// TODO: 在此添加您自己的模块终止代码。
